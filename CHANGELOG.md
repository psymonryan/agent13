...
- fix(windows): close subprocess transports + kill children on cancel across sandbox, remote exec/transfer, MCP shutdown
- minor prompt change that permits compaction prompts to use a project name if stated
